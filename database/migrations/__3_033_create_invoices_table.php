...
class CreateInvoicesTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('invoices', function (Blueprint $table) {
            ...
            $table->integer('delivery_company_id')->nullable()->unsigned();
            ...
            $table->string('tipo_spedizione')->nullable();
            $table->text('note_spedizione')->nullable();
            $table->float('peso_spedizione', 8,2)->nullable();
            $table->smallInteger('colli_spedizione')->nullable();
