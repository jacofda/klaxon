@if($user->can('accounting.read') || $user->can('newsletter.read'))
    @php
        $unread = Jacofda\Klaxon\Models\Notification::countUnread();
        $all = Jacofda\Klaxon\Models\Notification::count();
    @endphp
    <li class="nav-item dropdown">
        ...
        @if($all)
            <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                ...
                @foreach(Jacofda\Klaxon\Models\Notification::unread()->latest()->take(4)->get() as $notification)
