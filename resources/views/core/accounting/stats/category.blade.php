...
@include('jacofda::layouts.elements.title', ['title' => $category->nome])
        ...
        @foreach($data as $prod_id => $values)
            <div class="col-12 col-xs-6 col-md-3">
                <div class="small-box bg-info">
                    <div class="inner">
                        <h6 class="mb-1 text-center font-weight-bold">{{\App\Classes\Accounting\Product::find($prod_id)->nome}}</h6>
