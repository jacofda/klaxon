...
@include('jacofda::layouts.elements.title', ['title' => 'Fatture'])
        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    @include('jacofda::core.accounting.invoices.components.search')
                            ...
                            <tbody>
                                @foreach($invoices as $invoice)
                                    <tr id="row-{{$invoice->id}}">
                                        ...
                                        @endif
                                        <td class="text-center">
                                            @include('jacofda::core.accounting.invoices.components.index-actions')
                                        </td>
                                    </tr>
...
@if(request()->input())
    @include('jacofda::core.accounting.invoices.components.stats-bottom-nograph')
@else
    @include('jacofda::core.accounting.invoices.components.stats-bottom')
    @include('jacofda::core.accounting.invoices.components.stats-months')
@endif
