@include('jacofda::core.accounting.invoices.form-components.intestazione')
@include('jacofda::core.accounting.invoices.form-components.dettagli')
@include('jacofda::core.accounting.invoices.form-components.corpo')


<div class="col-md-6">

    @include('jacofda::core.accounting.invoices.form-components.extra-pa')
    @include('jacofda::core.accounting.invoices.form-components.extra-ddt')
    @include('jacofda::core.accounting.invoices.form-components.extra-estero')
