...
@include('jacofda::layouts.elements.title', ['title' => 'Costi'])
...
@section('content')
            ...
            <div class="card">
                <div class="card-header bg-secondary-light pb-0">
                    <div class="row">
                        ...
                        <div class=" col-6 col-sm-4 col-xl-3 text-right">
    ...
    @include('jacofda::core.accounting.costs.components.stats-bottom')
@stop
...
$('.select2Cat').select2({theme: 'bootstrap4', width: '100%', placeholder: 'Seleziona Categoria'});
...
function sendForm()
{
    ...
    window.location.href = '?company_id='+company+'&category_id='+category+'&anno='+anno+'&mese='+mese;
}
