<div class="row">
        ...
        <div class="col col-md-3">
            <div class="small-box bg-warning">
                <div class="inner">
                    ...
                    <p class="mb-0">{{$company->sconto}}%</p>
                    <p class="mb-0" style="font-size:80%;">{{$company->s1}}% + {{$company->s2}}% + {{$company->s3}}%</p>
                </div>
            </div>
        </div>
    @endif
    ...
    @if($company->exemption_id)
        @php
            $ex = Jacofda\Klaxon\Models\Exemption::find($company->exemption_id);
        @endphp
