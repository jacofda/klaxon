...
@section('scripts')
<script>
    $('a#menu-erp-ordini-works').addClass('active');
    $('a#menu-erp-ordini-works').parent('li').parent('ul.nav-treeview').css('display', 'block');
    $('a#menu-erp-ordini-works').parent('li').parent('ul').parent('li.has-treeview ').addClass('menu-open');
</script>
@stop
