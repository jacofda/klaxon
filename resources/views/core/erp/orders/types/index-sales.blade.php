...
@include('jacofda::layouts.elements.title', ['title' => __('Assemblies')])
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">{{__('Assemblies')}}</h3>
...
@section('scripts')
<script>
    $('a#menu-erp-ordini-sales').addClass('active');
    $('a#menu-erp-ordini-sales').parent('li').parent('ul.nav-treeview').css('display', 'block');
    $('a#menu-erp-ordini-sales').parent('li').parent('ul').parent('li.has-treeview ').addClass('menu-open');
</script>
@stop
