...
@include('jacofda::layouts.elements.title', ['title' => __('Create') . ' ' .__('Purchase')])
...
<div class="row">
    <div class="col-12 col-sm-12">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">{{__('Create')}} {{__('Purchase')}}</h3>
            </div>
            <div class="card-body">
    ...
    <div class="col-6">
        <div class="card">
            <div class="card-header">
                <h5 class="header-title mb-0">Ordinabili</h5>
            </div>
            <div class="card-body">
    ...
    <div class="col-6">
        {!! Form::open(['url' => route('erp.orders.store.purchases'), 'id' => 'pFrom']) !!}
            ...
            <div class="card">
                ...
                <div id="hidden-footer" class="card-footer p-0 d-none">
                    <button type="submit" class="submitForm btn btn-block btn-success">Salva</button>
                </div>
            </div>
        {!! Form::close() !!}
    </div>
