...
@include('jacofda::layouts.elements.title', ['title' => 'Report '.$newsletter->nome])
...
{{-- http://localhost/test-rider/public/newsletters/6/reports/aperte --}}
                                ...
                                <ul class="list-group">
                                    @foreach($clicks as $click)
                                        <li class="list-group-item d-flex justify-content-between align-items-center">
                                            <a href="{{$click->url}}" target="_BLANK">{{str_replace(config('app.url'), '',$click->url)}}</a>
