...
use Jacofda\Klaxon\Models\Erp\Order as ErpOrder;

class Invoice extends Primitive
{
    protected $dates = ['data', 'data_registrazione', 'ddt_data_doc', 'pa_data_doc', 'data_saldo', 'data_scadenza', 'data_spedizione'];
...
// setter
    ...
    public function setDataSpedizioneAttribute($value)
    {
        $this->attributes['data_spedizione'] = is_null($value) ? null : Carbon::createFromFormat('d/m/Y', $value);
    }
...
//getter
    ...
    //     if($this->tipo == 'D')
    //     {
    //         if($this->orders()->spedizioni()->exists())
    //         {
    //             return $this->orders()->spedizioni()->first()->id;
    //         }
    //     }
    //     return null;
    // }
    ...
    //     if($this->tipo == 'D')
    //     {
    //         if($this->orders()->lavorazioni()->exists())
    //         {
    //             return $this->orders()->lavorazioni()->first()->id;
    //         }
    //     }
    //     return null;
    // }
