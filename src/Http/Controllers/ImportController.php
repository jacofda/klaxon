...
use Jacofda\Klaxon\Models\{City, Client, Company, Contact, Csv, Product, Sector};
        ...
        elseif($model == 'companies')
        {
            foreach($dataCsv as $row)
            {
                ...
                if(isset($data['nazione']))
                {
                    ...
                    {
                        $country = Jacofda\Klaxon\Models\Country::where('name', $data['nazione'])->first();
                        if(!is_null($country))
                        {
