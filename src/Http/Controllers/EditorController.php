...
use Jacofda\Klaxon\Models\{Editor, Media, Template};
use \Storage;
...
//template-builder - GET
    public function editor()
    {
        ...
        return view('jacofda::core.editor.template-builder', compact('elements', 'update', 'page'));
    }

//new-template-builder - GET
    public function createTemplateBuilder()
    {
        return view('jacofda::core.editor.create-template-builder');
    }

//edit-template-builder/{id} - GET
    public function editTemplateBuilder($id)
    {
        return view('jacofda::core.editor.edit-template-builder', compact('id'));
    }
...
//template-builder/{id} - GET
    public function editorWithTemplate($id)
    {
        ...
        $page = $template->url;
        return view('jacofda::core.editor.template-builder', compact('elements', 'update', 'template', 'page'));
    }

//editor/elements/{slug} - GET
    public function show($slug)
    {
        return view('jacofda::core.editor.elements.'.$slug);
    }
